...
function get_circuit_connector_sprites(mainOffset, shadowOffset, connectorNumber)
 ...
 -- ultimate solar big
require("prototypes.entity.ultimate-solar-big")
require("prototypes.item.ultimate-solar-big")
require("prototypes.crafting.ultimate-solar-big")
require("prototypes.technology.ultimate-solar-big")
